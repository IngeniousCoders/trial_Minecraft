...
import com.ingeniousmc.tutrialmod.container.LightningChannelerContainer;
import com.ingeniousmc.tutrialmod.tileentity.LightningChannelerTile;
    ...
    private INamedContainerProvider createContainerProvider(World worldIn, BlockPos pos) {
        return new INamedContainerProvider() {
            ...
            public ITextComponent getDisplayName() {
                return new TranslationTextComponent("screen.tutrialmod.lightning_channeler");
            }
